  ...
  "rounded-xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        glass: "bg-secondary/30 backdrop-blur-xl border border-border/50",
        gradient: "bg-gradient-to-br from-card to-secondary border border-border/50",
        glow: "bg-card border border-primary/20 shadow-lg shadow-primary/10 hover:shadow-primary/20",
      },
    },
    defaultVariants: {
      variant: "default",
